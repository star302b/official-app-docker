...
?>
<section class="content-section dark-section section-overlay" style="background-image: url(<?php echo IMAGE_URL; ?>img/content/pexels-scott-webb-27406.jpg);" data-name="Features" data-description="Variant 4 (icon - 'fa-angle-double-right')">

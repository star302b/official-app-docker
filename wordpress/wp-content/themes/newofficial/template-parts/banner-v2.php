...
<section class="hero-banner" style="background-image: url(<?php if( get_field('background_image1','option')): echo get_field('background_image1','option'); else: ?><?php echo IMAGE_URL; ?>img/hero/hero-bg-2.jpg<?php endif; ?>)"  data-name="Hero Banner" data-description="With Image, Form-Right">

...
?>
<section class="content-section dark-section section-overlay" style="background-image: url(<?php echo IMAGE_URL; ?>img/content/pexels-olya-kobruseva-8919570.jpg);" data-name="Features" data-description="Variant 2 (icon - 'fa-balance-scale-left')">

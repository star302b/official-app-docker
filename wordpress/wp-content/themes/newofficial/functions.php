...
function acf_load_funnel_field_choices($field)
{
    ...
    ,{"funnel_name":"Bitcoin Smarter","funnel_code":"Bitcoin Smarter","funnel_image":"bitcoin-smarter-logo.png","funnel_badge_rating":"95","fulfilment_id":""}
    ,{"funnel_name":"Bit Index AI","funnel_code":"Bit Index AI","funnel_image":"bitindex-ai-logo.png","funnel_badge_rating":"96","fulfilment_id":""}
    ,{"funnel_name":"Bitcoin Decode","funnel_code":"Bitcoin Decode","funnel_image":"bitcoin-decode-logo.png","funnel_badge_rating":"96","fulfilment_id":""},{"funnel_name":"QProfit","funnel_code":"QProfit","funnel_image":"qprofit.jpg","funnel_badge_rating":"97","fulfilment_id":""},{"funnel_name":"PrimeBit Profit","funnel_code":"PrimeBit Profit","funnel_image":"primebit-profit.jpg","funnel_badge_rating":"96","fulfilment_id":""},
    {"funnel_name":"Bitindex Prime","funnel_code":"Bitindex Prime","funnel_image":"Bitindex-Prime-logo.png","funnel_badge_rating":"97","fulfilment_id":""},
    {"funnel_name":"Bitcode Method","funnel_code":"Bitcode Method","funnel_image":"Bitcode-Method-logo.png","funnel_badge_rating":"96","fulfilment_id":""},
    {"funnel_name":"Bitcoin Anleger","funnel_code":"Bitcoin Anleger","funnel_image":"Bitcoin-Anleger-logo.png","funnel_badge_rating":"96","fulfilment_id":""},
    {"funnel_name":"Bitcoin Decoder","funnel_code":"Bitcoin Decoder","funnel_image":"Bitcoin-Decoder-logo.png","funnel_badge_rating":"96","fulfilment_id":""},
    {"funnel_name":"Bitcoin Optimiser","funnel_code":"Bitcoin Optimiser","funnel_image":"Bitcoin-Optimiser-logo.png","funnel_badge_rating":"96","fulfilment_id":""}]';
...
function ff_post_funnel()
{
    ...
    $api_url = 'https://coininsiderapi.com/p/lead';
    ...
    if( $_SERVER['HTTP_HOST'] == 'bitcodeprime.co.uk' || $_SERVER['HTTP_HOST'] == 'bitcodeprime.io' || $_SERVER['HTTP_HOST'] == 'bitcodeprime.org'){
        $api_key = 'FSQZ7QSWC33AEQ4EURA87ATV0HHTWWYK';
    }

    if( $_SERVER['HTTP_HOST'] == 'wordpress-811360-2783903.cloudwaysapps.com' ){
...
function filter_document_title( $title ) {
    ...
    if(is_home() && get_field('global_home_page_title','option')){
...
function trustRandomDate($end_date,$start_date )
{
    // Convert to timetamps
    $min = date('U');
    $max = strtotime("1 january 2022");
